...
export const LoadingProvider = ({ children }: { children: ReactNode }) => {
    ...
    return (
        <LoadingContext.Provider value={{ isAnimation, setIsAnimation, loadingStart, oldPathname, setOldPathname, isLoading, setIsLoading, direction, setDirection, nextUrl, setNextUrl }}>
            {children}
